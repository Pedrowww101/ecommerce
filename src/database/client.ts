...
console.log("DB URL CHECK:", process.env.DATABASE_DATABASE_URL ? "SET" : "NOT SET");
if (!process.env.DATABASE_DATABASE_URL) throw Error("Database connection env not set up");
